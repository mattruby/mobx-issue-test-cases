		...
		1: [
			function (require, module, exports) {
				(function (global) {
					...
					var actionFieldDecorator = createClassPropertyDecorator(function (target,
						key,
						value,
						args,
						originalDescriptor) {
					...
					function reaction (arg1, arg2, arg3, arg4, arg5, arg6) {
						...
						if (delay === void 0)
							delay = 0;
						var _a = getValueModeFromValue(expression,
							ValueMode.Reference), valueMode = _a[0], unwrappedExpression = _a[1];
					...
					var computedDecorator = createClassPropertyDecorator(function (target,
						name,
						_,
						decoratorArgs,
						originalDescriptor) {
						...
						invariant(typeof baseValue === "function",
					...
					function createTransformer (transformer, onCleanup) {
						invariant(typeof transformer === "function" && transformer.length === 1,
					...
					function observableDecorator (target, key, baseDescriptor) {
						...
						invariant(!baseDescriptor || !baseDescriptor.get,
					...
					function toJSlegacy (source, detectCycles, __alreadySeen) {
						...
						deprecated(
							"toJSlegacy is deprecated and will be removed in the next major. Use `toJS` instead. See #566");
						function cache (value) {
							if (detectCycles)
								__alreadySeen.push([source, value]);
							return value;
					...
					function executeAction (actionName, fn, scope, args) {
						invariant(!isComputedValue(globalState.trackingDerivation),
					...
					function useStrict (strict) {
						if (arguments.length === 0) {
							...
							invariant(globalState.trackingDerivation === null,
					...
					var ComputedValue = (function () {
						...
						ComputedValue.prototype.onBecomeUnobserved = function () {
							invariant(this.dependenciesState !== IDerivationState.NOT_TRACKING,
						...
						ComputedValue.prototype.set = function (value) {
							if (this.setter) {
								invariant(!this.isRunningSetter,
					...
					function getValueModeFromModifierFunc (func) {
						...
						invariant(mod !== null,
							"Cannot determine value mode from function. Please pass in one of these: mobx.asReference, mobx.asStructure or mobx.asFlat, got: " + func);
						return mod;
					}
					...
					function makeChildObservable (value, parentMode, name) {
						...
						switch (parentMode) {
							...
							case ValueMode.Recursive:
								_a = getValueModeFromValue(value,
									ValueMode.Recursive), childMode = _a[0], value = _a[1];
								break;
							default:
								invariant(false, "Illegal State");
						}
					...
					var ObservableArrayAdministration = (function () {
						...
						ObservableArrayAdministration.prototype.spliceWithArray = function (index,
							deleteCount,
							newItems) {
					...
					function createArraySetter (index) {
						return function (newValue) {
							...
							if (index < values.length) {
								...
								var changed = (adm.mode === ValueMode.Structure) ? !deepEquals(oldValue,
					...
					var ObservableMap = (function () {
						...
						ObservableMap.prototype.set = function (key, value) {
							...
							assertUnwrapped(value,
								"[mobx.map.set] Expected unwrapped value to be inserted to key '" + key + "'. If you need to use modifiers pass them as second argument to the constructor");
							if (hasInterceptors(this)) {
								var change = interceptChange(this, {
					...
					function defineObservableProperty (adm, propName, newValue, asInstanceProperty, setter) {
						...
						if (asInstanceProperty) {
							Object.defineProperty(adm.target,
								propName,
								isComputed ? generateComputedPropConfig(propName) : generateObservablePropConfig(
									propName));
						}
						if (!isComputed)
					...
					var isObservableObjectAdministration = createInstanceofPredicate("ObservableObjectAdministration",
					...
					var ObservableValue = (function (_super) {
						...
						function ObservableValue (value, mode, name, notifySpy) {
							...
							this.value = undefined;
							var _a = getValueModeFromValue(value,
								ValueMode.Recursive), childmode = _a[0], unwrappedValue = _a[1];
								...
								var newDescriptor = {
									...
									get: function () {
										if (!this.__mobxInitializedProps || this.__mobxInitializedProps[key] !== true)
											typescriptInitializeProperty(this,
												key,
												undefined,
												onInitialize,
												customArgs,
					...
					function assertPropertyConfigurable (object, prop) {
						invariant(isPropertyConfigurable(object, prop),
